# AGENTS.md — src/delivery-persons/auth/
...
- Password assignment and access revocation → `src/admin/delivery-persons/`. The delivery person never sets or changes their own password, and cannot revoke their own session.
- Customer OTP/JWT authentication → `src/auth/`.
