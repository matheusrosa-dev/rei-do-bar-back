...
Each service method first calls a private "load me or throw" helper to confirm the customer exists, optionally including addresses. Mutations then proceed via nested Prisma writes on the customer's relations.
...
| Rule | Detail |
|---|---|
| Existence check first | Every method starts by resolving the customer or throwing |
