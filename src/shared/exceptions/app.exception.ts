...
export class AppException extends HttpException {
  ...
  static readonly errorCodes = {
    ...
    adminProducts: {
      ...
      INVALID_CATEGORY_GROUPS_ORDER: "ADMIN_PRODUCTS_005",
      INVALID_PRODUCTS_ORDER: "ADMIN_PRODUCTS_006",
    },
    adminCategories: {
      ...
      INVALID_CATEGORY_GROUP: "ADMIN_CATEGORIES_005",
    },
    adminCategoryGroups: {
      CATEGORY_GROUP_NOT_FOUND: "ADMIN_CATEGORY_GROUPS_001",
      CATEGORY_GROUP_ALREADY_EXISTS: "ADMIN_CATEGORY_GROUPS_002",
      CATEGORY_GROUP_HAS_CATEGORIES: "ADMIN_CATEGORY_GROUPS_003",
      INVALID_CATEGORY_GROUPS_ORDER: "ADMIN_CATEGORY_GROUPS_004",
      INVALID_CATEGORIES_ORDER: "ADMIN_CATEGORY_GROUPS_005",
    },
    adminCustomers: {
    ...
    adminOrders: {
      ...
      ORDER_NOT_SHIPPED: "ADMIN_ORDERS_004",
    },
    adminInventory: {
      INSUFFICIENT_STOCK: "ADMIN_INVENTORY_001",
      PRODUCT_NOT_FOUND: "ADMIN_INVENTORY_002",
      DUPLICATE_PRODUCT: "ADMIN_INVENTORY_003",
      MOVEMENT_NOT_FOUND: "ADMIN_INVENTORY_004",
      MOVEMENT_NOT_EDITABLE: "ADMIN_INVENTORY_005",
    },
    adminCoupons: {
    ...
    deliveryPersonsAuth: {
      INVALID_CREDENTIALS: "DELIVERY_PERSONS_AUTH_001",
      INVALID_REFRESH_TOKEN: "DELIVERY_PERSONS_AUTH_002",
      INVALID_ACCESS_TOKEN: "DELIVERY_PERSONS_AUTH_003",
    },
    deliveryPersonsOrders: {
      ORDER_NOT_FOUND: "DELIVERY_PERSONS_ORDERS_001",
      ORDER_NOT_SHIPPED: "DELIVERY_PERSONS_ORDERS_002",
    },
