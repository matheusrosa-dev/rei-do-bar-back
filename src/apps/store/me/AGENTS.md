...
Contrast this with admin customer deletion, which is a plain hard delete refused outright when orders exist (see `src/apps/admin/customers/AGENTS.md`). The two are not the same operation.
